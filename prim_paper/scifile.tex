...
\includegraphics[scale=0.5]{gpucalc_cpu.png}
\label{cpugpu_times} 
\end{figure}
...
\end{center}
 ...
 It seems like the GPU is getting more effective in comparison to the CPU, the bigger the numbers get.
