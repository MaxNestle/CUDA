...
Hovhannes Bantikyan from the University of Armenia did time measurements up to the size of 200000 digits for each factor and compared the results with other bignum multiplication libraries \cite{bantikyan2014big}. On the contrary, the results of cuFFT are compared with the \mintinline{c}{BN_mul()} function in this paper.
